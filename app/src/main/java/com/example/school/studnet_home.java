...
public class studnet_home extends Fragment {
...
private TextView textView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v= inflater.inflate(R.layout.fragment_studnet_home, container, false);
        recyclerView=v.findViewById(R.id.student_recyclerview);
        db= FirebaseDatabase.getInstance().getReference("notices").child("All");
        ...
        progressDialog.show();
textView=v.findViewById(R.id.studenthomenotfound);
